...
void CScene::BuildDefaultLightsAndMaterials()
{
	...
	m_pLights[0].m_xmf4Diffuse = XMFLOAT4(0.7f, 0.5f, 0.2f, 1.0f);
	m_pLights[0].m_xmf4Specular = XMFLOAT4(0.3f, 0.3f, 0.3f, 0.0f);
	m_pLights[0].m_xmf3Direction = XMFLOAT3(500.0f, 100.0f, 500.0f);
...
ID3D12RootSignature* CScene::CreateGraphicsRootSignature(ID3D12Device* pd3dDevice)
{
	...
	pd3dDescriptorRanges[10].BaseShaderRegister = 0; //t0: Texture2DArray
	pd3dDescriptorRanges[10].RegisterSpace = 0;
	pd3dDescriptorRanges[10].OffsetInDescriptorsFromTableStart = 0;

	pd3dDescriptorRanges[11].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	pd3dDescriptorRanges[11].NumDescriptors = 3;
	pd3dDescriptorRanges[11].BaseShaderRegister = 14; //t14: Texture2D<float4>
	...
	pd3dRootParameters[16].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[10]; //Texture2DArray
	...
	pd3dRootParameters[17].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[11]; //Texture2D
