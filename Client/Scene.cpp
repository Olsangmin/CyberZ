...
ID3D12RootSignature* CScene::CreateGraphicsRootSignature(ID3D12Device* pd3dDevice)
{
	...
	//pd3dDescriptorRanges[12].BaseShaderRegister = 25; //t20: gtxtParticleTexture
	...
	//pd3dRootParameters[19].DescriptorTable.pDescriptorRanges = &(pd3dDescriptorRanges[13]); //Texture2D
